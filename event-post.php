...
<div class="wrap">
    ...
    <hr style="margin: 0 10%;">
		...
		<div id="post-content">
            ...
            <div>
                <h4>Social Media</h4>
                <?php if( get_field('event_facebook') ): ?>
                    <a href="<?php echo the_field('event_facebook'); ?>" target="_blank" style="margin-right: 10px;">Facebook</a>
                <?php endif; ?>
                <?php if( get_field('event_instagram') ): ?>
                    <a href="<?php echo the_field('event_instagram'); ?>" target="_blank" style="margin-right: 10px;">Instagram</a>
                <?php endif; ?>
            </div>
        </div>
